...
class BaseFitter(ABC):
    ...
    def __init__(self,
        ...
        self.prior_dict = {}
        self.idata = PySersicResults(data=self.data,rms=self.rms,psf=psf,mask=mask,loss_func=loss_func,renderer=self.renderer)
    ...
    def sample(self,
        ...
        self.idata.injest_data(sampler = self.sampler)
        return self.idata 
    ...
    def _train_SVI(self,
        ...
        self.idata.injest_data(svi_res_dict=svi_res_dict)
        return self.idata
